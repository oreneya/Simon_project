...
instant.train(train_pics, train_targets, niter=300, eta=10., mu=5.)
instant.save(flname="part4a_mu5.wgt")
'''
...
for mu in [0, 5]:
	instant = Backprop(196, 10, 20)
	instant.load(flname="part4a_mu"+str(mu)+".wgt")
	...
	# print summary
	print("\nPart 4a - confusion matrix mu="+str(mu)+"\n")
	print(conf_mat)
